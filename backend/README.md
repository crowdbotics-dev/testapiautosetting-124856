...
## Project Structure
    ...
    ├── testapiautosetting_124856  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_124856`
...
2. Clone this repo and `cd testapiautosetting_124856`
